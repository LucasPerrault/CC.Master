    ...
    public static class PermissionsExtensions
    {
        ...
        public static byte[] ToBytes(this List<IUserPermission> permissions)
        {
            ...
            foreach (var permission in permissions)
            {
                ...
                BitConverter.GetBytes((ushort)(permission.LegalEntityId ?? default)).CopyTo(bytes, offset + UserPermissionBytes.Positions.LegalEntityId);
                ...
                BitConverter.GetBytes(permission.HasContextualLegalEntityAssociation).CopyTo(bytes, offset + UserPermissionBytes.Positions.HasContextualLegalEntityAssociation);
        ...
        public static Permission ToPermission(this byte[] bytes, int offset)
        {
            return new Permission
            {
                ...
                LegalEntityId = ParseNonDefault(bytes, offset + UserPermissionBytes.Positions.LegalEntityId),
                ...
                HasContextualLegalEntityAssociation = BitConverter.ToBoolean(bytes, offset + UserPermissionBytes.Positions.HasContextualLegalEntityAssociation)
            };
        }
        ...
        public static byte[] ToBytes(this List<IApiKeyPermission> permissions)
        {
            ...
            foreach (var permission in permissions)
            {
                ...
                BitConverter.GetBytes((ushort)(permission.LegalEntityId ?? 0)).CopyTo(bytes, offset + ApiKeyPermissionBytes.Positions.LegalEntityId);
        ...
        public static IApiKeyPermission ToApiKeyPermission(this byte[] bytes, int offset)
        {
            return new ApiKeyPermission
            {
                ...
                LegalEntityId = ParseNonDefault(bytes, offset + ApiKeyPermissionBytes.Positions.LegalEntityId),
            };
        }
