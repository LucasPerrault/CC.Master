...
export class UserApiSelectService extends LuApiV3Service<IPrincipal> {
  ...
  public getAll(filters?: string[]): Observable<IPrincipal[]> {
    return this._getWithDefaultPrincipal$([this.url, ...filters].join('&'), this.defaultOption);
  }
  ...
  public getPaged(page: number, filters: string[] = []): Observable<IPrincipal[]> {
    ...
    return this._getWithDefaultPrincipal$(url, this.defaultOption);
  }
  ...
  public searchAll(clue: string, filters: string[] = []): Observable<IPrincipal[]> {
    ...
    return this._getWithDefaultPrincipal$(url, this.defaultOption, clue);
  }
  ...
  private _getWithDefaultPrincipal$(url: string, defaultOption: IPrincipal, clue?: string): Observable<IPrincipal[]> {
