...
import { ProductApiSelectComponent } from './product-api-select.component';

@NgModule({
  declarations: [ProductApiSelectComponent],
  imports: [
    CommonModule,
    LuSelectInputModule,
    FormsModule,
  ...
  exports: [ProductApiSelectComponent],
})
export class ProductApiSelectModule { }
